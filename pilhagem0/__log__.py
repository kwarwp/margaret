...
{'date': 'Tue Oct 15 2019 10:19:02.605 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
...
RuntimeError: too much recursion
  module '$exec_495' line 33
    pilhagem = Pilhagem()
'''},
{'date': 'Tue Oct 15 2019 10:28:59.926 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
RuntimeError: too much recursion
...
RuntimeError: too much recursion
  module '$exec_515' line 33
    pilhagem = Pilhagem()
'''},
{'date': 'Tue Oct 15 2019 10:59:16.285 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
